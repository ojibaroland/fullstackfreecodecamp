        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <div className="space-y-6">
            <div className="glass rounded-2xl p-6">
              ...
              <form onSubmit={handleInvite} className="space-y-4">
                ...
                <div>
                  ...
                  <select value={personNode} onChange={(e) => setPersonNode(e.target.value)}
                    className="w-full rounded-xl px-4 py-3 text-sm outline-none"
            ...
            <div className="glass rounded-2xl p-6">
              ...
              <p className="text-gray-400 text-sm mb-4">Anyone with this link can request to join.</p>
              {shareLink ? (
                <div>
                  <div className="rounded-xl px-4 py-3 text-xs font-mono text-amber-400 break-all mb-2"
                ...
                <button onClick={copyLink} className="btn-outline-gold w-full py-3 rounded-xl text-sm font-semibold">
              ...
              <div className="space-y-3">
                {UNCLAIMED_NODES.map((node) => (
                  <div key={node.id} className="flex items-center gap-3 p-3 rounded-xl"
                    ...
                    <button onClick={() => setPersonNode(node.id)}
