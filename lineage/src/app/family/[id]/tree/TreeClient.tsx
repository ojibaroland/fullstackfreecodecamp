...
export default function TreeClient({ id }: { id: string }) {
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <header className="glass border-b border-amber-400/10 px-6 py-4 flex items-center gap-4 z-20 flex-shrink-0">
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={() => setShowAddPerson(true)} className="btn-gold px-4 py-2 rounded-lg text-xs font-bold">
            + Add Person
          </button>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3 mt-2">
                <button onClick={() => setShowAddPerson(false)}
                  className="flex-1 btn-outline-gold py-3 rounded-xl text-sm font-semibold">Cancel</button>
                <button onClick={() => setShowAddPerson(false)}
                  className="flex-1 btn-gold py-3 rounded-xl text-sm font-bold">Add Person →</button>
              </div>
            </div>
          </div>
        </div>
