      ...
      <main className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          ...
          <p className="text-gray-400 text-sm leading-relaxed max-w-2xl">
            Download your complete family archive as a structured JSON file. This includes the full family
            tree, all media metadata, relationship graph, and time-lock manifests. Media files are
            referenced by S3 key — contact support for a full binary export.
          </p>
        </div>
        ...
        <div className="glass rounded-2xl p-6 mb-6 border" style={{ borderColor: "rgba(212,168,67,0.2)" }}>
          ...
          <div className="space-y-3 text-sm text-gray-400">
            <p>
              <strong className="text-amber-300">Locked media content</strong> is NOT included in the
              export — only the manifest (caption, release date, status). The encrypted content and key
              remain server-side until the lock opens.
            </p>
            <p>
              <strong className="text-amber-300">Media files</strong> are referenced by S3 key but not
              bundled. The export format is designed to be re-importable to any future Lineage instance
              or compatible tool.
            </p>
            <p>
              <strong className="text-amber-300">Format version:</strong>{" "}
              <code className="text-violet-400 font-mono">lineage-archive-v1</code> — documented at
              the export root. Future-proof design intent.
            </p>
          </div>
        </div>
        ...
        <div className="glass rounded-2xl p-6 mb-6">
          ...
          {!showPreview && (
            <div className="rounded-xl px-4 py-3 text-xs font-mono text-gray-500"
              ...
              <span className="text-green-400">&quot;lineage-archive-v1&quot;</span>,{" "}
              <span className="text-amber-400">&quot;people&quot;</span>: [...],{" "}
              <span className="text-amber-400">&quot;relationships&quot;</span>: [...],{" "}
              <span className="text-amber-400">&quot;media&quot;</span>: [...],{" "}
              <span className="text-amber-400">&quot;timeLocks&quot;</span>: [...]{" "}
              <span className="text-violet-400">{"}"}</span>
            </div>
          )}
        </div>
        ...
        <div className="grid grid-cols-4 gap-4 mb-8">
          {[
            ...
            { label: "Relationships", value: "14" },
            { label: "Media Items", value: "47" },
            { label: "Time-Locks", value: "3" },
          ].map((s) => (
        ...
        <p className="text-center text-xs text-gray-600">
          Your data is always yours. We will never hold it hostage. 🤝
        </p>
      </main>
    </div>
  );
